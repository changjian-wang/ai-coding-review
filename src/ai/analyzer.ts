...
const FILE_SYSTEM_PROMPT_ZH = `你是一名严格的资深代码审查员。审查给定源码文件的逻辑、正确性、并发与安全问题。
...
const FILE_SYSTEM_PROMPT_EN = `You are a strict senior code reviewer. Review the given source file for logic, correctness, concurrency, and security issues.
Output JSON only. Do not output explanations or markdown code fences.
JSON schema: {"findings":[{"line":<1-based line>,"endLine":<optional>,"anchor":"verbatim code snippet from the issue location (exact text, no line-number prefix, one or more contiguous lines, ideally uniquely locatable in file)","severity":"bug"|"conditional"|"suggestion","title":"short title","detail":"issue and evidence","suggestion":"optional fix advice"}]}
...
JSON schema:
{
  ...
  "fixSpots": [
    {"file":"relative path","line":<1-based line>,"severity":"bug"|"conditional"|"suggestion","title":"title","detail":"details","suggestion":"optional fix"}
  ]
}
