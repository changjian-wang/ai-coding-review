...
export const en = {
  ...
  report: {
    ...
    summary: 'Summary',
    filesLine: (ready: number, total: number) => `Files: ${ready}/${total} fully reviewed`,
    coverageLine: (seen: number, total: number) => `Line coverage: ${seen}/${total}`,
    findingsLine: (n: number) => `Findings: ${n}`,
    unhandledLine: (n: number) => `Unhandled findings: ${n}`,
    filesHeading: 'Findings by file',
    noFindings: 'No findings.',
    noFindingsInFile: 'No findings in this file.',
    line: (n: number) => `line ${n}`,
    dispositionFixed: 'Fixed (Copilot)',
    dispositionCommented: 'Commented',
    dispositionIgnored: 'Ignored',
    dispositionOpen: 'Open',
    reason: 'Reason',
    notesHeading: 'Notes & explanations',
    noteKindTranslate: 'Translation',
    noteKindExplain: 'Explanation',
    noteKindNote: 'Note',
    globalHeading: 'Global analysis',
    ...
    targetLocal: 'Local record',
    notSubmitted: 'Not submitted yet.',
    sevBug: 'Bug',
    sevConditional: 'Conditional',
    sevSuggestion: 'Suggestion',
  },
  ...
  prPanel: {
    ...
    filterPlaceholder: 'Filter by #number / title / author / branch…',
    tabActive: 'Active',
    tabMine: 'Mine',
    tabAll: 'All',
    tabOpen: 'Open',
  ...
  workbench: {
    ...
    exportReport: 'Export review report',
    cancel: 'Cancel',
    modelPrefix: 'Model: ',
    switch: 'Switch',
  ...
  documentPanel: {
    ...
    note: 'Note',
    comment: 'Comment',
    commentPrompt: 'Write a review comment, or a brief point and expand it with the ✨ button.',
    commentAiExpand: 'Expand into a review comment with AI',
    commentAiNeedsPoint: 'Write a brief point first, then use AI to expand it.',
    commentPlaceholder: 'Your comment…',
    commentEmpty: 'Enter a comment, or press Esc to cancel.',
    commentAdded: 'Added to pending review',
    commentNotPr: 'Comments can only be added when reviewing a PR.',
    commentNonePending: 'No pending comments.',
    commentDelete: 'Delete comment',
    pendingTitle: 'Pending review comments',
    pendingPlaceholder: 'Select to jump to it, or click the trash icon to delete.',
  ...
  fixPanel: {
    ...
    badgeNotFound: 'File changed — click Regenerate',
    badgeAmbiguous: 'Matches multiple places',
  ...
  globalPanel: {
    ...
    suggestionPrefix: 'Suggestion: ',
    confirmedReadBadge: '✓ Global re-review confirmed',
    confirmReadBtn: 'Confirm I read the global re-review',
    fixWithCopilot: '🪄 Fix with Copilot',
    // To-do list redesign
    ...
    allHandledHint: 'All fix spots handled.',
    ...
    // Global re-review promoted to a first-class section + gate status (single source of truth)
    sectionReview: 'Global re-review (confirm / overturn / new finds)',
    reviewSubtitle:
      'File-level sees one file at a time and tends to say "maybe"; here cross-file facts turn those into confirm / overturn / new finds.',
    sectionFixAdvisory: 'Fix spots (advisory)',
    fixSpotsAdvisoryNote: 'Fix spots are advisory and do not block the gate; handle or ignore as needed.',
    gatePassTitle: 'Gate passed · ready to submit',
    gateFailTitle: 'Gate not passed · hold off',
    gateHowTo: 'To pass the gate, complete these steps:',
    gateAllMet: '✓ All gate items met — you can submit this review.',
    gateFilesDone: 'All files read and analyzed',
    gateStepFiles: (n: number) => `Go back to "① File-level review" and finish reading & analyzing the remaining ${n} file(s)`,
    gateGlobalDone: 'Global re-review confirmed',
    gateStepGlobal: 'Read the global re-review below, then click the button to confirm',
    gateGotoFiles: 'Go to file review',
    aiVerdictPrefix: 'AI verdict: ',
  },
  ...
  gh: {
    ...
    installAction: 'Install GitHub CLI',
    docsAction: 'Open install docs',
